// bonne pratique : mettre chaque classe dans des fichiers spérarer, ex: Hero.js, HeroAxe.js ...
export class Weapon {
    name: string;
    damage: number;
...
// ça serait top de mettre la classe Hero en abstract, pour éviter d'en créer des instances
export class Hero {
    name: string;
    power: number;
    life: number;
